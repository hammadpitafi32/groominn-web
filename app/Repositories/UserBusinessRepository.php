...
class UserBusinessRepository implements UserBusinessInterface
{
  ...
  //       ->with(['user_categories' => function ($query) {
	...
	{
		$request = $this->request;
		$user_business = $this->user_business->with('user_business_images','user_business_schedules','user_business_category_services','user_business_category_services.user_category','user_business_category_services.user_service','user_categories');
